...
class Student:
    ...
    # This part is image labels setting start 
        # first header image  
        img=Image.open(r"C:\Users\USER\Documents\Face_Recognition_Attendance\Images_GUI\banner.jpg")
        ...
        f_lb1.place(x=0,y=0,width=1366,height=130)
         ...
         # backgorund image 
        bg1=Image.open(r"C:\Users\USER\Documents\Face_Recognition_Attendance\Images_GUI\bg3.jpg")
        ...
        dep_combo["values"]=("Select Department","Department of CSIT","Department of CCE","Department of EEE","Department of PME","Department of Mathematics")
        dep_combo.current(0)
        ...
        cou_combo["values"]=("Select Course","Networking","Numerical Method","Microprocessor","Artificial Intelligence","COA")
        cou_combo.current(0)
        ...
        student_roll_entry = ttk.Entry(class_Student_frame,textvariable=self.var_reg,width=15,font=("verdana",12,"bold"))
        ...
        self.student_table.heading("Reg-No",text="Roll-No")
...
# ==================Function Decleration==============================
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_course.get=="Select Course" or self.var_year.get()=="Select Year" or self.var_semester.get()=="Select Semester" or self.var_std_id.get()=="" or self.var_std_name.get()=="" or self.var_div.get()=="" or self.var_reg.get()=="" or self.var_gender.get()=="" or self.var_dob.get()=="" or self.var_email.get()=="" or self.var_mob.get()=="" or self.var_address.get()=="" or self.var_teacher.get()=="":
    ...
    def search_data(self):
        if self.var_search.get()=="" or self.var_searchTX.get()=="Select":
            ...
            try:
                ...
                sql = "SELECT Student_ID,Name,Department,Course,Year,Semester,Division,Gender,DOB,Mobile_No,Address,Reg_No,Email,Teacher_Name,PhotoSample FROM student where Roll_No='" +str(self.var_search.get()) + "'" 
