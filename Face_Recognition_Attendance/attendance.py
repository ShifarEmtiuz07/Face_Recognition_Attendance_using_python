...
class Attendance:
    ...
    def __init__(self,root):
        ...
        #Student Roll
        student_roll_label = Label(left_frame,text="Reg_No:",font=("verdana",12,"bold"),fg="navyblue",bg="white")
        student_roll_label.grid(row=0,column=2,padx=5,pady=5,sticky=W)

        student_roll_entry = ttk.Entry(left_frame,textvariable=self.var_reg,width=15,font=("verdana",12,"bold"))
        ...
        self.attendanceReport_left.heading("Reg_No",text="Reg_No")
        ...
        # Set Width of Colums 
        self.attendanceReport_left.column("ID",width=20)
        self.attendanceReport_left.column("Reg_No",width=20)
        self.attendanceReport_left.column("Name",width=20)
        self.attendanceReport_left.column("Time",width=20)
        self.attendanceReport_left.column("Date",width=20)
        self.attendanceReport_left.column("Attend",width=20)
        ...
        self.attendanceReport.heading("Reg_No",text="Reg_No")
        ...
        self.attendanceReport.column("Reg_No",width=20)
        self.attendanceReport.column("Name",width=20)
        self.attendanceReport.column("Time",width=20)
        self.attendanceReport.column("Date",width=20)
        self.attendanceReport.column("Attend",width=20)
    ...
    def update_data(self):
        if self.var_id.get()=="" or self.var_reg.get=="" or self.var_name.get()=="" or self.var_time.get()=="" or self.var_date.get()=="" or self.var_attend.get()=="Status":
            ...
            try:
                ...
                if Update > 0:
                    ...
                    mycursor.execute("update stdattendance set std_id=%s,std_reg_no=%s,std_name=%s,std_time=%s,std_date=%s,std_attendance=%s where std_id=%s",( 
                    self.var_id.get(),
                    self.var_reg.get(),
                    self.var_name.get(),
                    self.var_time.get(),
